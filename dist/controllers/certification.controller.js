...
export async function handleGetAllCertification(req, res) {
    try {
...
export async function handleCreateCertification(req, res) {
    try {
...
export async function handleUpdateCertification(req, res) {
    try {
        const { id } = req.params;
...
export async function handleDeleteCertification(req, res) {
    try {
        const { id } = req.params;
